...
class PersonViewSkillStateAddImpl extends React.PureComponent {
    ...
    handleGridRowDbClick(e) {
        let {addSkillState} = this.props;
        let skillStateId = e.data.id;
        if (this.popup != null) {
            this.popup.hide();
        }
        addSkillState(skillStateId);
    }
                ...
                <Popup
                    ...
                    <DataGrid
                        ...
                        <StateStoring
                            ...
                            type={'localStorage'}
                            savingTimeout={0}
                            storageKey={'PersonViewSkillStateAddTable'}/>
                        <Column dataField={'id'} dataType={'string'} caption={'Код записи'}
                                visible={false}/>
...
export default PersonViewSkillStateAddImpl;