...
import DictWorldSkillViewRoot from "./DictWorldSkillViewRoot";
...
class DictWorldSkillViewImpl extends React.PureComponent {
    ...
    render() {
        ...
        if (isNotFound) {
            ...
            return (
                <DictWorldSkillViewRoot/>
            )
        }
    }
}

export default DictWorldSkillViewImpl;