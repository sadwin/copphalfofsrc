...
import DictMunicipalViewRoot from "./DictMunicipalViewRoot";
...
class DictMunicipalViewImpl extends React.PureComponent {
    ...
    render() {
        ...
        if (isNotFound) {
            ...
            return (
                <DictMunicipalViewRoot/>
            )
        }
    }
}

export default DictMunicipalViewImpl;