...
class DictLegalFormViewToolbarImpl extends React.PureComponent {
    ...
    handleGoBackClick() {
        this.props.history.push("/work/app/dict/legal-form");
    }
...
export default DictLegalFormViewToolbarImpl;