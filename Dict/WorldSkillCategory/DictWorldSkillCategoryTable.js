...
class DictWorldSkillCategoryTable extends React.Component {
        ...
        this.dataSource = new DataSource({
            store: new CustomStore({
                ...
                load: function (loadOptions) {
                    return axios.get("/work/api/dict/world-skill-category", {
                        headers: {
    ...
    render() {
        return (
            <DataGrid
                ...
                <Export enabled={true} fileName={'Блоки компетенций Ворлдскиллс'} allowExportSelectedData={true}/>
                ...
                <StateStoring
                    ...
                    type={'localStorage'}
                    savingTimeout={0}
                    storageKey={'DictWorldSkillCategoryTable'}/>
    ...
    handleRowDblClick(e) {
        this.props.history.push('/work/app/dict/world-skill-category/' + e.data.id);
    }

    handleAddButton() {
        axios.post("/work/api/dict/world-skill-category",
            {},
            {
                headers: {
                    'Accept': 'application/json'
            ...
            this.props.history.push("/work/app/dict/world-skill-category/" + response.data.id);
        }).catch(() => {
            notify({
                closeOnClick: true,
                closeOnOutsideClick: true,
...
export default DictWorldSkillCategoryTable;