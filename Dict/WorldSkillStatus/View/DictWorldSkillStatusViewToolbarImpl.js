...
class DictWorldSkillStatusViewToolbarImpl extends React.PureComponent {
    ...
    handleGoBackClick() {
        this.props.history.push("/work/app/dict/world-skill-status");
    }
    handleRefreshClick() {
...
export default DictWorldSkillStatusViewToolbarImpl;