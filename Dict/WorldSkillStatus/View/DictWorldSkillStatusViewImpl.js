...
import DictWorldSkillStatusViewRoot from "./DictWorldSkillStatusViewRoot";
...
class DictWorldSkillStatusViewImpl extends React.PureComponent {
    ...
    render() {
        ...
        if (isNotFound) {
            ...
            return (
                <DictWorldSkillStatusViewRoot/>
            )
        }
    }
}

export default DictWorldSkillStatusViewImpl;