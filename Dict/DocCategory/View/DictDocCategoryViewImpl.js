...
import DictDocCategoryViewRoot from "./DictDocCategoryViewRoot";
...
class DictDocCategoryViewImpl extends React.PureComponent {
    ...
    render() {
        ...
        if (isNotFound) {
            ...
            return (
                <DictDocCategoryViewRoot/>
            )
        }
    }
}

export default DictDocCategoryViewImpl;