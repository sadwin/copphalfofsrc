...
class DictDocCategoryTable extends React.Component {
        ...
        this.dataSource = new DataSource({
            store: new CustomStore({
                ...
                load: function (loadOptions) {
                    return axios.get("/work/api/dict/doc-category", {
                        headers: {
    ...
    render() {
        return (
            <DataGrid
                ...
                <Export enabled={true} fileName={'Категории документов'} allowExportSelectedData={true}/>
                ...
                <StateStoring
                    ...
                    type={'localStorage'}
                    savingTimeout={0}
                    storageKey={'DictDocCategoryTable'}/>
                ...
                <Column dataField={'system'} dataType={'boolean'} caption={'Системная'}/>
    ...
    handleRowDblClick(e) {
        this.props.history.push('/work/app/dict/doc-category/' + e.data.id);
    }

    handleAddButton() {
        axios.post("/work/api/dict/doc-category",
            {},
            {
                headers: {
                    'Accept': 'application/json'
            ...
            this.props.history.push("/work/app/dict/doc-category/" + response.data.id);
        }).catch(() => {
            notify({
                closeOnClick: true,
                closeOnOutsideClick: true,
...
export default DictDocCategoryTable;