...
class DictWorldSkillTypeViewToolbarImpl extends React.PureComponent {
    ...
    handleGoBackClick() {
        this.props.history.push("/work/app/dict/world-skill-type");
    }
...
export default DictWorldSkillTypeViewToolbarImpl;